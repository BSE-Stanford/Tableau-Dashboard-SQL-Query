...
WHERE
    ...
    AND t.assignment_group IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager',
    'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)','FMS Financial Systems and Operations Support (Secure)' )
...
WHERE
    ...
    AND ( m.assignment_group = 'FMS Evolve Financial Reporting (EFR) Support (Secure)'
        ...
        WHERE
            ...
            AND o_r.value IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager',
            'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)','FMS Financial Systems and Operations Support (Secure)' )
...
FROM
    task_bs.task r
WHERE
    assignment_group IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager',
    'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)' ,'FMS Financial Systems and Operations Support (Secure)')
