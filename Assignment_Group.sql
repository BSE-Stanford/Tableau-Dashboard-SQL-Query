...
WHERE
    ...
    AND ( m.assignment_group IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager','FMS Financial Systems and Operations Support (Secure)',
    'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)' )
          OR EXISTS (
        SELECT
            1
        FROM
        ...
        WHERE
            ...
            AND o_r.value IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager','FMS Financial Systems and Operations Support (Secure)',
            'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)' )
...
WHERE
    ...
    AND t.assignment_group IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager','FMS Financial Systems and Operations Support (Secure)',
    'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)' )
...
FROM
    task_bs.task r
WHERE
    assignment_group IN ( 'FMS Financial Support Center-LD (Secure)', 'FMS Systems and Reporting Operations (Secure)', 'FMS PTA Manager','FMS Financial Systems and Operations Support (Secure)',
    'FMS iJournals/Feeder Request', 'FMS Chart of Accounts', 'FMS Financial Support Center-FFIT (Secure)' )
